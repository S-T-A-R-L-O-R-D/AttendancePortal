	...
	<div class=container>
		...
		<br/>
			...
			<form action="login_teacher_script.jsp" method="post">
				...
				<input type="text" name="t_uid" placeholder="Enter UID" class="form-control"  required="true">
				</div>
				<div class="form-group">
				<input type="password" name="t_name" placeholder="Enter Password" class="form-control" required="true">
				</div>
				<div class="form-group">
